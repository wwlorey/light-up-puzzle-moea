...
comparisons. These 56 comparisons were performed for both the provided puzzle and the randomly generated puzzle.

The explicit statistical analysis is not tabulated in this report for brevity, however, the statistical analysis
methodology is as follows. First, the last best subfitness for each of the three subfitness were aggregated into separate 
...
subordinates for a given comparison, that configuration was marked as being better than another, incrementing a 
dominance count associated with the configuration. The configuration(s) with the highest dominance count are statistically
...
selection, tournament survival selection, and plus survival strategy. Both of these solutions each were dominant to two other configurations
...
this configuration was the only solution that was statistically better than all other configurations. This configuration involved
