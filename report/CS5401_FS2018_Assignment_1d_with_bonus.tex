...
\hline               
 ...
 Unequal variances assumed &  &    \\ \hline 
  ...
  Nether random\_gen\_uniform\_random\_init & & \\
  nor random\_gen is statistically better &  &   \\ \hline 
  \end{tabular}%     
}                    
\end{table}
...
\hline               
 ...
 Unequal variances assumed &  &    \\ \hline 
  ...
  t Critical two-tail & 1.9864 &  \\ \hline 
  Nether website\_puzzle\_uniform\_random\_init & & \\
  nor website\_puzzle is statistically better &  &   \\ \hline 
  \end{tabular}%     
}                    
\end{table}
...
\hline               
 ...
 Equal variances assumed &  &    \\ \hline 
  ...
  Nether random\_gen\_\_tournament\_parent\_\_tournament\_survival\_\_plus & & \\
  nor random\_gen\_\_fitness\_proportional\_parent\_\_fitness\_proportional\_survival\_\_plus & & \\
  is statistically better &  &   \\ \hline 
  \end{tabular}%     
}                    
\end{table}
...
\hline               
 ...
 Equal variances assumed &  &    \\ \hline 
  ...
  t Critical two-tail & 1.984 &  \\ \hline 
  Nether random\_gen\_\_tournament\_parent\_\_tournament\_survival\_\_comma & & \\
  nor random\_gen\_\_fitness\_proportional\_parent\_\_fitness\_proportional\_survival\_\_comma & & \\
  is statistically better &  &   \\ \hline 
  \end{tabular}%     
}                    
\end{table}
...
\hline               
 ...
 Unequal variances assumed &  &    \\ \hline 
  ...
  t Critical two-tail & 1.9864 &  \\ \hline 
  random\_gen\_\_fitness\_proportional\_parent\_\_tournament\_survival\_\_plus & & \\
  is statistically better than & & \\
  random\_gen\_\_tournament\_parent\_\_fitness\_proportional\_survival\_\_plus &  &   \\ \hline 
  \end{tabular}%     
}                    
\end{table}
...
\hline               
 ...
 Unequal variances assumed &  &    \\ \hline 
  ...
  t Critical two-tail & 1.9864 &  \\ \hline 
  Nether random\_gen\_\_tournament\_parent\_\_fitness\_proportional\_survival\_\_comma  & &\\
  nor random\_gen\_\_fitness\_proportional\_parent\_\_tournament\_survival\_\_comma & &\\
  is statistically better &  &   \\ \hline 
  \end{tabular}%     
}                    
\end{table}
...
\hline               
 ...
 Equal variances assumed &  &    \\ \hline 
  ...
  t Critical two-tail & 1.984 &  \\ \hline 
  Nether random\_gen\_\_tournament\_parent\_\_tournament\_survival\_\_plus & & \\
  nor random\_gen\_\_tournament\_parent\_\_tournament\_survival\_\_comma & & \\
  is statistically better &  &   \\ \hline 
  \end{tabular}%     
}                    
\end{table}
