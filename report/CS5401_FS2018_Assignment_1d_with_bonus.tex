...
puzzle can be found in tables \ref{}, \ref{}, and \ref{} for the provided puzzle experiments and in tables 
\ref{}, \ref{}, and \ref{} for the randomly generated puzzle experiments.  Additionally, figures for one of the dominant MOEA configurations can be found in figures \ref{},
\ref{}, and \ref{} for the provided puzzle experiments and in figures \ref{}, \ref{}, and \ref{} 
for the randomly generated puzzle experiments. Note that these dominating configurations are described at length below in this section.
